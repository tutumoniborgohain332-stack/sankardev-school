...
CREATE INDEX "students_class_idx" ON "students" USING btree ("class_name");--> statement-breakpoint
CREATE INDEX "students_roll_idx" ON "students" USING btree ("roll_number");--> statement-breakpoint
CREATE INDEX "students_section_idx" ON "students" USING btree ("section");--> statement-breakpoint
CREATE INDEX "admissions_status_idx" ON "admissions" USING btree ("status");--> statement-breakpoint
CREATE INDEX "results_roll_class_year_idx" ON "results" USING btree ("roll_number","class_name","academic_year");--> statement-breakpoint
CREATE INDEX "results_exam_idx" ON "results" USING btree ("exam_type");--> statement-breakpoint
...
CREATE INDEX "attendance_class_idx" ON "attendance" USING btree ("class_name");--> statement-breakpoint
