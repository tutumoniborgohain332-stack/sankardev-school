...
import { useSubmitAdmission } from "@/lib/api-client";
...
export default function Admission() {
  ...
  const { admissionOpen, isLoading } = useAdmissionOpen();
            ...
            <CardContent className="pt-8">
              {isLoading ? (
                ...
                <div className="text-center py-12 space-y-4">
                  <h2 className="text-2xl font-bold text-red-600">Admissions are currently closed</h2>
                  <p className="text-muted-foreground">We are not accepting new admission applications at this time. Please check back later.</p>
                </div>
              ) : (
              <Form {...form}>
